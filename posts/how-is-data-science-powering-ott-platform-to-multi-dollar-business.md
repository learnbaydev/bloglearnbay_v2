...
- _Platform searches, i.e., keywords and number of searches._
- _Know if the viewer has paused, rewatched, rewound, or forwarded. (It even saves when the show was paused, when the user left it, or which scene the viewer repeats)._
- _Content rate and desertion time._
- _Subscribers' scrolling and browsing behavior._
